		...
		self.drawMesh = function (mesh_data_z,store_data,mesh_data_x,mesh_data_y,mesh_data_z_height) {
			...
			try {
				...
				new PNotify({
						...
						text: '<div class="row-fluid">Looks like your settings are not correct or there was an error.  Please see the <a href="https://github.com/jneilliii/OctoPrint-BedLevelVisualizer/blob/master/README.md">Readme</a> for configuration hints.</div><pre style="padding-top: 5px;">'+err+'</pre>',
						type: 'error',
						hide: false
						});
			}
